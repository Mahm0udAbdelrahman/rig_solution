...
class CalibrationYokePolicy
{
    ...
    {
        return $user->hasPermission('calibrationyoke', 'all');
    }
    ...
    {
        return $user->hasPermission('calibrationyoke', 'show');
    }
    ...
    {
        return $user->hasPermission('calibrationyoke', 'create');
    }
    ...
    {
        return $user->hasPermission('calibrationyoke', 'edit');
    }
    ...
    {
        return $user->hasPermission('calibrationyoke', 'delete');
    }
