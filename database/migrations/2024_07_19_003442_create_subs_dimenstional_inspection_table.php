...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('subs_dimensionals', function (Blueprint $table) {
            $table->id();
        ...
        DB::table('footer_values')->insert([
            'related_inspection' => \App\Models\Inspection\Tubular\SubsDimensional::class,
            'name' => 'Subs Dimensional Inspection Report',
            'form_no' => 'RS-RF-F18',
            'issue_no' => '04',
    ...
    {
        Schema::dropIfExists('subs_dimensionals');

        /****Delete Drill Pipe footer values*****/
        \App\Models\GeneralInfo\FooterValue::query()
            ->where('related_inspection', '=','App\Models\Inspection\Tubular\SubsDimensional')
            ->delete();
    }
};
