...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('reamer_inspections', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('reamer_condition')->nullable();
            $table->string('reamer_slots')->nullable();
        ...
        DB::table('footer_values')->insert([
            'related_inspection' => \App\Models\Inspection\Tubular\ReamerInspection::class,
            'name' => 'Reamer Inspection Report',
            'form_no' => 'RS-RF-F18',
            'issue_no' => '04',
    ...
    {
        Schema::dropIfExists('reamer_inspections');

        /****Delete Drill Pipe footer values*****/
        \App\Models\GeneralInfo\FooterValue::query()
            ->where('related_inspection', '=','App\Models\Inspection\Tubular\ReamerInspection')
            ->delete();
    }
};
