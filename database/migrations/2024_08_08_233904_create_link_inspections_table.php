...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('link_inspections', function (Blueprint $table) {
            $table->id();
        ...
        DB::table('footer_values')->insert([
            'related_inspection' => \App\Models\Inspection\Tubular\LinkInspection::class,
            'name' => 'Link Inspection Report',
            'form_no' => 'RS-RF-F18',
            'issue_no' => '04',
    ...
    {
        Schema::dropIfExists('link_inspections');


        /****Delete Drill Pipe footer values*****/
        \App\Models\GeneralInfo\FooterValue::query()
            ->where('related_inspection', '=','App\Models\Inspection\Tubular\LinkInspection')
            ->delete();
    }
};
