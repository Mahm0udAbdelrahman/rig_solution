          ...
          <div class="row">
            <div class="col-12 col-sm-6">
              <div class="form-group">
                  <div class="controls">
                      <label>Code</label>
                      <input type="text" name="code" class="form-control" placeholder="Code" value="{{$supplier->code}}" required="" data-validation-required-message="This code field is required" aria-invalid="false" disabled>
                  <div class="help-block"></div></div>
              </div>
              <div class="form-group">
                  <div class="controls">
                      <label>Name</label>
                      <input type="text" name="uname" class="form-control" placeholder="Supplier Name" value="{{$supplier->name}}" required="" data-validation-required-message="This name field is required" aria-invalid="false">
                  <div class="help-block"></div></div>
              </div>
            </div>
            <div class="col-12 col-sm-6 mt-1 mt-sm-0">
              <div class="form-group">
                  <div class="controls">
                      <label>E-mail</label>
                      <input type="email" name="uemail" class="form-control" placeholder="Supplier Email" value="{{$supplier->email}}" required="" data-validation-required-message="This email field is required" aria-invalid="false">
                  <div class="help-block"></div></div>
              </div>
              <div class="form-group">
                  <div class="controls">
                      <label>Telephone</label>
                      <input type="tel" name="utel" class="form-control" placeholder="Supplier Telephone" value="{{$supplier->tel}}" required="" data-validation-required-message="This telephone field is required" aria-invalid="false">
                  <div class="help-block"></div></div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                  ...
                  <input type="text" name="address" class="form-control" value="{{$supplier->location}}" placeholder="Supplier Address" aria-invalid="false">
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <div class="form-group">
                  <div class="controls">
                      ...
                      <input type="url" class="form-control" name="url" id="url" value="{{$supplier->url}}" placeholder="WebSite Url" >
                  <div class="help-block"></div></div>
              </div>
            </div>
            <div class="col-12 col-sm-6 mt-1 mt-sm-0">
            ...
            <div class="col-12">
              <div class="form-group">
                  <label>Desc.</label>
                  <input type="text" name="desc" value="{{$supplier->desc}}" class="form-control" placeholder="Supplier Description" aria-invalid="false">
              </div>
            </div>
          </div>
