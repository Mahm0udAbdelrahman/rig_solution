                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <label>Name</label>
                                                    <input type="text" name="uname" class="form-control" placeholder="Role Name" value="{{$role->name}}" required="" data-validation-required-message="This name field is required" aria-invalid="false">
                                                ...
                                                <div class="row">
                                                    <table class="table form-group mb-0">
                                                        ...
                                                        <tbody class="controls">';
                                                            App\Http\Controllers\CustomController::get_classes(ucfirst($key), ucwords(str_replace('-',' ',$value1)),$role->roles, '');
                                                        echo '</tbody>
                                                    </table>
                                                </div>
                                            </div>
...
<script>
    $.each($('.switchery:checked'), function (i, value){
        permissions.push({
            modules : value.id,
            roles : [],
        });
        $(value).closest('.top').find('.custom-control-input').prop( "disabled", false );
    });

    $.each($('.custom-control-input:checked'), function (iii, value2){
        var parent_id = $(value2).closest('.top').find('.switchery').attr('id');
        var roles = $(value2).attr('id').replace(parent_id+"-", "");
