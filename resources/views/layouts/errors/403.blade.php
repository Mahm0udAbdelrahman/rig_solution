                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-8 col-10 p-0">
                            <div class="card-header bg-transparent border-0">
                                ...
                                <h3 class="text-uppercase text-center">THIS ACTION IS UNAUTHORIZED.</h3>
                            </div>
                            <div class="card-content">
                                <div class="row py-2">
                                    <div class="col-12 col-sm-6 col-md-6 mb-1 offset-3">
                                        <a href="/" class="btn btn-primary btn-block"><i class="ft-home"></i> Dashboard</a>
                                    </div>
                                </div>
                            </div>
