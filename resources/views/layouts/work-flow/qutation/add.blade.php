                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <select class="form-control csd searchable-select" id="client" name="csd" required
                                                        ...
                                                        <option value="{{$job_request_id}}"
                                                                selected>{{$job_request_code}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <fieldset class="col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="deliverydate" placeholder="Delivery Promise"
                                                       class="form-control dp-date-range-from" required=""
                                                       data-validation-required-message="This field is required"
                                                       value="{{$job_request_delivery_promise ?? ''}}"/>
                                            </div>
                                        </fieldset>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="creation_date" placeholder="Creation Data"
                                                               class="form-control dp-date-range-from" required=""
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            <input type="text" name="subject" class="form-control"
                                                   placeholder="Qutation Subject" aria-invalid="false" required=""
                                                   data-validation-required-message="This field is required">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-content collapse show">
                                        <div id="invoice-template" class="card-body">
                                            <div id="invoice-items-details" class="pt-2">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group mb-0">
                                                            <div class="controls">
                                                                <label>Curreny in <span
                                                                            class="months">USD</span></label>
                                                                <div style="display: inline-block; float: right; margin-left: 10px;">
                                                                    <input type="checkbox" class="switchery mr-1"
                                                                           id="suporcli" name="suporcli" checked>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <hr/>
                                                <div class="row">
                                                    <div class="table-responsive col-12 repeater">
                                                        <table class="table titems">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="col-md-2 text-right">Price In <span
                                                                            class="months">USD</span></th>
                                                            ...
                                                            <tr data-repeater-item>
                                                                <td class="col-md-1">
                                                                    <input type="text" placeholder="Code" name="icode"
                                                                           class="form-control icode text-center"
                                                                           style="padding: 0;">
                                                                </td>
                                                                <td class="col-md-3">
                                                                    <textarea class="form-control" name="idesc" rows="2"
                                                                              required=""
                                                                              data-validation-required-message="This field is required"
                                                                ...
                                                                <td class="col-md-1">
                                                                    <input type="number" placeholder="0"
                                                                           name="pquantity"
                                                                           class="form-control pquantity text-center"
                                                                           min=1 style="padding: 0;">
                                                                </td>
                                                                <td class="col-md-2">
                                                                    <input type="number" placeholder="0" name="price"
                                                                           class="form-control price text-center" min=1
                                                                           style="padding: 0;">
                                                                </td>
                                                                ...
                                                                <td class="col-md-2 text-right">
                                                                    <input type="number" placeholder="0" name="pamount"
                                                                           class="form-control pamount text-center"
                                                                           min=1 style="padding: 0;">
                                                                </td>
                                                                <td class="col-md-1">
                                                        ...
                                                        <div class="form-group overflow-hidden">
                                                            <div class="col-12">
                                                                <button type="button" data-repeater-create
                                                                        class="btn btn-info"><i class="ft-plus"></i> Add
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div data-repeater-item class="row ">
                                                        <div class="controls col-3">
                                                            <input type="text" name="conditionname" class="form-control"
                                                                   placeholder="Condition Name" aria-invalid="false">
                                                        </div>
                                                        <div class="controls col-8">
                                                            <input type="text" name="conditiondesc" class="form-control"
                                                                   required
                                                                   data-validation-required-message="This field is required"
                                                                   placeholder="Condition Desc." aria-invalid="false">
                                                        </div>
                                                        <div class=" col-1">
                                                            <button type="button" class="btn btn-danger"
                                                    ...
                                                    <div data-repeater-item class="row ">
                                                        <div class="controls col-3">
                                                            <input type="text" name="methodname" class="form-control"
                                                                   placeholder="Method Name" aria-invalid="false">
                                                        </div>
                                                        <div class="controls col-8">
                                                            <input type="text" name="methoddesc" class="form-control"
                                                                   required
                                                                   data-validation-required-message="This field is required"
                                                                   placeholder="Method Desc." aria-invalid="false">
                                                        </div>
                                                        <div class=" col-1">
                                                            <button type="button" class="btn btn-danger"
                                                                    data-repeater-delete><i class="ft-x"></i></button>
