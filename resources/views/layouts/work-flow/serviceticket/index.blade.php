...
@section('content')
		<section class="users-list-wrapper">
				<div class="users-list">
						@can('create', 'App\Models\WorkFlow\ServiceTicket')
								@include('layouts.repeated.workflow-jcf-create-picker', [
										'picker_id' => 'serviceticket-jcf-create',
										'button_label' => 'Create New Service Ticket',
										'route_template' => route('serviceTicket.serviceTicketWithJobRequest', ['jobRequest' => '__ID__']),
										'modal_title' => 'Create Service Ticket From JCF',
										'empty_text' => 'No JCF is currently available to create a Service Ticket.',
