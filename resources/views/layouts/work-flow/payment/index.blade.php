...
@section('content')
		<section class="users-list-wrapper">
				<div class="users-list">
						@can('create', 'App\Models\WorkFlow\Payment')
								@include('layouts.repeated.workflow-jcf-create-picker', [
										'picker_id' => 'payment-jcf-create',
										'button_label' => 'Create New Payment',
										'route_template' => route('payment.paymentWithJobRequest', ['jobRequest' => '__ID__']),
										'modal_title' => 'Create Payment From JCF',
										'empty_text' => 'No JCF is currently available to create a payment.',
...
@include('layouts.scripts.datatables', [
		...
		'columns' => ['code', 'job_request_code', 'client', 'invoice_code', 'bank_account', 'payment_date', 'amount', 'method', 'status', 'employee', 'action'],
		'datatable_options' => [
				'ordering' => true,
				'order' => [[0, 'desc']],
				'useFilterRow' => true,
