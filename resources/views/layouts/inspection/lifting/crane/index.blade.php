...
@section('content')
		<section class="users-list-wrapper">
				<div class="users-list">
						@if ($cranes == 0)
								@include('layouts.repeated.nodata', ['route' => 'crane'])
						@else
								@can('create', 'App\Models\Inspection\Lifting\Crane')
										<a href="{{route('crane.create')}}" class="btn btn-primary clear"><i class="la la-plus"></i> Create New {{ucfirst(str_replace('All ', '', substr($page_name, 0, -1)))}}</a>
								@endcan
								<div class="card">
...
@include('layouts.scripts.datatables', ['route' => 'crane', 'columns' => ['report_code', 'id_number', 'desc', 'client', 'client_department','deploc', 'action'],
