                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <select class="form-control" id="lcr_1" name="lcr_1" required=""
                                                            disabled>
                                                        <option value="{{$crane->job_request->id}}"
                                                                selected>{{$crane->job_request->code}}</option>
                                                    </select>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="purchaseOrder" name="lcr_2" class="form-control"
                                                           placeholder="Purchase Order" value="{{$crane->lcr_2}}" disabled>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="clearfix">
                                                        <input type="text" id="precode" class="form-control pr-0"
                                                               ...
                                                               value="{{$crane->job_request->code}} /" required=""
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control dp-date-range-to"
                                                               id="lcr_7" name="lcr_7" value="{{$crane->lcr_7}}"
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_8" name="lcr_8" class="form-control"
                                                           placeholder="Color Code" value="{{$crane->lcr_8}}"
                                                           required=""
                                                           data-validation-required-message="This field is required"/>
                                                    <div class="help-block"></div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_10" name="lcr_10" class="form-control"
                                                           placeholder="Type of Crane and nature of Power"
                                                           value="{{$crane->lcr_10}}" required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_11" name="lcr_11" class="form-control"
                                                           placeholder="Name of Manufacturer" value="{{$crane->lcr_11}}"
                                                           required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_13" name="lcr_13" class="form-control"
                                                           placeholder="Model/Type" value="{{$crane->lcr_13}}"
                                                           required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control dp-date-range-from"
                                                               id="lcr_14" name="lcr_14" value="{{$crane->lcr_14}}"
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_15" name="lcr_15" class="form-control"
                                                           placeholder="Crane Capacity (SWL)" value="{{$crane->lcr_15}}"
                                                           required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_17" name="lcr_17" class="form-control"
                                                           placeholder="SLI Identification number(if fitted)"
                                                           value="{{$crane->lcr_17}}" required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_18" name="lcr_18" class="form-control"
                                                           placeholder="Number of falls/lines"
                                                           value="{{$crane->lcr_18}}" required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="lcr_19" name="lcr_19"
                                                               ...
                                                               placeholder="Date of last Through Examination"
                                                               value="{{$crane->lcr_19}}" required=""
                                                               data-validation-required-message="This field is required"/>
                                                    </div>
                                                    <div class="help-block"></div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_20" name="lcr_20" class="form-control"
                                                           placeholder="Certificate Number" value="{{$crane->lcr_20}}"
                                                           required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_21" name="lcr_21" class="form-control"
                                                           placeholder="Examined by" value="{{$crane->lcr_21}}"
                                                           required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control dp-date-range-from"
                                                               ...
                                                               placeholder="Date of last Load Test"
                                                               value="{{$crane->lcr_22}}" required=""
                                                               data-validation-required-message="This field is required"/>
                                                    </div>
                                                    <div class="help-block"></div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_23" name="lcr_23" class="form-control"
                                                           placeholder="Certificate Number" value="{{$crane->lcr_23}}"
                                                           required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_24" name="lcr_24" class="form-control"
                                                           placeholder="Tested by" value="{{$crane->lcr_24}}"
                                                           required=""
                                                           data-validation-required-message="This field is required">
                                                    <div class="help-block"></div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="lcr_25" name="lcr_25" class="form-control"
                                                           placeholder="Reference Standard" value="{{$crane->lcr_25}}"
                                                           required=""
                                                           data-validation-required-message="This field is required"/>
                                                    <div class="help-block"></div>
                                                </div>
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_26_y "
                                                       name="lcr_26"
                                                       required {{$crane->checkbox_yes($crane->lcr_26)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_26_n"
                                                       name="lcr_26" {{$crane->checkbox_no($crane->lcr_26)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_27_y "
                                                       name="lcr_27"
                                                       required {{$crane->checkbox_yes($crane->lcr_27)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_27_n"
                                                       name="lcr_27" {{$crane->checkbox_no($crane->lcr_27)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_28_y "
                                                       name="lcr_28"
                                                       required {{$crane->checkbox_yes($crane->lcr_28)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_28_n"
                                                       name="lcr_28" {{$crane->checkbox_no($crane->lcr_28)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_29_y "
                                                       name="lcr_29"
                                                       required {{$crane->checkbox_yes($crane->lcr_29)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_29_n"
                                                       name="lcr_29" {{$crane->checkbox_no($crane->lcr_29)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_30_y "
                                                       name="lcr_30"
                                                       required {{$crane->checkbox_yes($crane->lcr_30)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_30_n"
                                                       name="lcr_30" {{$crane->checkbox_no($crane->lcr_30)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_31_y "
                                                       name="lcr_31"
                                                       required {{$crane->checkbox_yes($crane->lcr_31)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_31_n"
                                                       name="lcr_31" {{$crane->checkbox_no($crane->lcr_31)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_33_y "
                                                       name="lcr_33" {{$crane->checkbox_yes($crane->lcr_33)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_33_n"
                                                       name="lcr_33" {{$crane->checkbox_no($crane->lcr_33)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_34_y "
                                                       name="lcr_34" {{$crane->checkbox_yes($crane->lcr_34)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_34_n"
                                                       name="lcr_34" {{$crane->checkbox_no($crane->lcr_34)}} />
                                        ...
                                        <div class="col-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control dp-date-range-from" id="lcr_35"
                                                       name="lcr_35" value="{{$crane->lcr_35}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <input type="text" id="lcr_38" name="lcr_38"
                                                               class="form-control" placeholder="@ Length of jib (1)"
                                                               value="{{$value->lcr_38}}" required=""
                                                               data-validation-required-message="This field is required"/>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <input type="text" id="lcr_39" name="lcr_39"
                                                               class="form-control" placeholder="@ Radius(iii) (2)"
                                                               value="{{$value->lcr_39}}" required=""
                                                               data-validation-required-message="This field is required"/>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <input type="text" id="lcr_40" name="lcr_40"
                                                               class="form-control" placeholder="Proof Load (3)"
                                                               value="{{$value->lcr_40}}" required=""
                                                               data-validation-required-message="This field is required"/>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <input type="text" id="lcr_41" name="lcr_41"
                                                               class="form-control" placeholder="SWL (4)"
                                                               value="{{$value->lcr_41}}" required=""
                                                               data-validation-required-message="This field is required"/>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    <input type="text" id="lcr_42" name="lcr_42" class="form-control"
                                                           placeholder="Length of jib (1)" value="{{$crane->lcr_42}}"/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    <input type="text" id="lcr_43" name="lcr_43" class="form-control"
                                                           placeholder="@ Radius(iii) (2)" value="{{$crane->lcr_43}}"/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    <input type="text" id="lcr_44" name="lcr_44" class="form-control"
                                                           placeholder="Proof Load (3)" value="{{$crane->lcr_44}}"/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    <input type="text" id="lcr_45" name="lcr_45" class="form-control"
                                                           placeholder="SWL (4)" value="{{$crane->lcr_45}}"/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_46_y "
                                                       name="lcr_46"
                                                       required {{$crane->checkbox_yes($crane->lcr_46)}} />
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="lcr_46_n"
                                                       name="lcr_46" {{$crane->checkbox_no($crane->lcr_46)}} />
...
// Needed in some cases if the user went back (clean up)
    ...
    onFinished: function (event, currentIndex) {
      ...
      // formdata.append('deploc', $('#deploc').val());
