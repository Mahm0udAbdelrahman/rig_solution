                                                ...
                                                <div class="controls">
                                                    ...
                                                    <select class="form-control" id="lcr_1" name="lcr_1" required="">
                                                        ...
                                                        @foreach($jobrequests as $jobrequest)
                                                            <option value="{{$jobrequest->id}}"  @if($jobrequest->id === $overheadcrane->job_request_id) selected @endif>{{$jobrequest->code}}</option>
                                                        @endforeach
																										</select>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input disabled type="text" id="purchaseOrder" name="locr_2" class="form-control" placeholder="Purchase Order" value="{{$overheadcrane->locr_2}}" required="" data-validation-required-message="This field is required" >
                                                <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
