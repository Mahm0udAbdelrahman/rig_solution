...
@push('page_content_second')
    <div class="row page_in">
        <div class="col-8 p-0">
            ...
            <div class="row" style="margin-left: 0; margin-right: 0;">
                <div class="col-6 p-0">
                    ...
                    <p class="border-dark pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_1}}</p>
                </div>
                <div class="col-6 p-0">
                    <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Description</h6>
                    <p class="border-dark pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_4}}</p>
                </div>
            </div>
        </div>
        <div class="col-2 p-0 border-dark" style="padding-top: 0!important;">
            ...
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_2}}</p>
        </div>
        <div class="col-2 p-0 border-dark" style="padding-top: 0!important;">
            <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Condition</h6>
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_3}}</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-2 p-0 border-dark">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_5}}</p>
        </div>
        <div class="col-2 p-0 bg-dark border-dark">
            <h6 class="white text-bold-600 pl-1 mb-0">Certificate Number</h6>
        </div>
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_6}}</p>
        </div>
        <div class="col-2 p-0 bg-dark border-dark">
            <h6 class="white text-bold-600 pl-1 mb-0">Date of Test</h6>
        </div>
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_7}}</p>
        </div>
    </div>
    <div class="row" style="margin-bottom: 3px;">
        ...
        <div class="border-dark col-8 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_8}}</p>
        </div>
    </div>
    <div class="row">
        <div class="col-8 p-0">
            ...
            <div class="row" style="margin-left: 0; margin-right: 0;">
                <div class="col-6 p-0">
                    <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">ID Number</h6>
                    <p class="border-dark pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_9}}</p>
                </div>
                <div class="col-6 p-0">
                    <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Description</h6>
                    <p class="border-dark pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_12}}</p>
                </div>
            </div>
        </div>
        <div class="col-2 p-0 border-dark" style="padding-top: 0!important;">
            <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Safe Working Load</h6>
            <p class=" pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_10}}</p>
        </div>
        <div class="col-2 p-0 border-dark" style="padding-top: 0!important;">
            <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Condition</h6>
            <p class=" pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_11}}</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_13}}</p>
        </div>
        <div class="col-2 p-0 bg-dark border-dark">
            <h6 class="white text-bold-600 pl-1 mb-0">Certificate Number</h6>
        </div>
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_14}}</p>
        </div>
        <div class="col-2 p-0 bg-dark border-dark">
            <h6 class="white text-bold-600 pl-1 mb-0">Date of Test</h6>
        </div>
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_15}}</p>
        </div>
    </div>
    <div class="row" style="margin-bottom: 3px;">
        <div class="col-4 p-0">
        ...
        <div class="border-dark col-8 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_16}}</p>
        </div>
    </div>
    <div class="row">
        <div class="col-8 p-0">
            ...
            <div class="row" style="margin-left: 0; margin-right: 0;">
                <div class="col-6 p-0">
                    <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">ID Number</h6>
                    <p class="border-dark pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_17}}</p>
                </div>
                <div class="col-6 p-0">
                    <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Description</h6>
                    <p class="border-dark pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_20}}</p>
                </div>
            </div>
        </div>
        <div class="border-dark col-2 p-0" style="padding-top: 0 !important;">
            <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Safe Working Load</h6>
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_18}}</p>
        </div>
        <div class="border-dark col-2 p-0" style="padding-top: 0 !important;">
            <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Condition</h6>
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_19}}</p>
        </div>
    </div>
    <div class="row">
        <div class="bg-dark col-2 p-0 border-dark">
        ...
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_21}}</p>
        </div>
        <div class="col-2 p-0 bg-dark border-dark">
            <h6 class="white text-bold-600 pl-1 mb-0">Certificate Number</h6>
        </div>
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_22}}</p>
        </div>
        <div class="col-2 p-0 bg-dark border-dark">
            <h6 class="white text-bold-600 pl-1 mb-0">Date of Test</h6>
        </div>
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_23}}</p>
        </div>
    </div>
    <div class="row" style="margin-bottom: 3px;">
        <div class="col-4 p-0">
        ...
        <div class="border-dark col-8 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_24}}</p>
        </div>
    </div>
    <div class="row">
        <div class="col-8 p-0">
            ...
            <div class="row" style="margin-left: 0; margin-right: 0;">
                <div class="col-6 p-0">
                    <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">ID Number</h6>
                    <p class="border-dark pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_25}}</p>
                </div>
                <div class="col-6 p-0">
                    <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Description</h6>
                    <p class="border-dark pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_28}}</p>
                </div>
            </div>
        </div>
        <div class="border-dark col-2 p-0" style="padding-top: 0 !important;">
            <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Safe Working Load</h6>
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_26}}</p>
        </div>
        <div class="border-dark col-2 p-0" style="padding-top: 0 !important;">
            <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Condition</h6>
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_27}}</p>
        </div>
    </div>
    <div class="row">
        <div class="bg-dark col-2 p-0 border-dark">
        ...
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_29}}</p>
        </div>
        <div class="col-2 p-0 bg-dark border-dark">
            <h6 class="white text-bold-600 pl-1 mb-0">Certificate Number</h6>
        </div>
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_30}}</p>
        </div>
        <div class="col-2 p-0 bg-dark border-dark">
            <h6 class="white text-bold-600 pl-1 mb-0">Date of Test</h6>
        </div>
        <div class="border-dark col-2 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_31}}</p>
        </div>
    </div>
    <div class="row" style="margin-bottom: 3px;">
        <div class="col-4 p-0">
        ...
        <div class="border-dark col-8 p-0">
            <p class="pl-1 mb-0 text-16 black">{{$overheadcrane2->locr2_32}}</p>
        </div>
    </div>
    ...
    <div class="row" style="margin-bottom: 3px;">
        <div class="col-8 p-0">
            <div class="row" style="margin: auto;">
                ...
                <p class="col-3 p-0 pl-1 border-dark text-16 black">{{$overheadcrane2->locr2_33}}</p>
                <h6 class="bg-dark white col-3 p-0 pl-1 mb-0 border-dark">Equipment type</h6>
                <p class="col-3 p-0 pl-1 border-dark text-16 black">{{$overheadcrane2->locr2_34}}</p>
            </div>
            <div class="row" style="margin: auto;">
                <h6 class="bg-dark white col-3 p-0 pl-1 mb-0 border-dark">Equipment No</h6>
                <p class="col-3 p-0 pl-1 border-dark text-16 black">{{$overheadcrane2->locr2_35}}</p>
                <h6 class="bg-dark white col-3 p-0 pl-1 mb-0 border-dark">Due Date</h6>
                <p class="col-3 p-0 pl-1 border-dark text-16 black">{{$overheadcrane2->locr2_37}}</p>
            </div>
            <div class="row" style="margin: auto;">
              <h6 class="bg-dark white col-3 p-0 pl-1 mb-0 border-dark">Pole spacing</h6>
              <p class="col-9 p-0 pl-1 border-dark text-16 black">{{$overheadcrane2->locr2_36}}</p>
        ...
        <div class=" col-4 p-0">
            ...
            <div class="row" style="margin: auto;">
                ...
                <p class="col-4 p-0 pl-1 border-dark text-16 black">{{$overheadcrane2->locr2_38}}</p>
                <p class="col-4 p-0 pl-1 border-dark text-16 black">{{$overheadcrane2->locr2_39}}</p>
            </div>
            <div class="row" style="margin: auto;">
                <h6 class="bg-dark white col-4 p-0 pl-1 mb-0 border-dark">Expire Date</h6>
                <p class="col-4 p-0 pl-1 border-dark text-16 black">{{$overheadcrane2->locr2_40}}</p>
                <p class="col-4 p-0 pl-1 border-dark text-16 black">{{$overheadcrane2->locr2_41}}</p>
            </div>
        </div>
    </div>
    <div class="row" style="margin-bottom: 3px;">
        <div class="col-12 p-0">
            ...
            <p class="border-dark pl-1 mb-0 text-16 black" style="height: 70px;">{!!nl2br(html_entity_decode($overheadcrane2->locr2_42))!!}</p>
        </div>
    </div>
    <div class="row" style="margin-bottom: 3px;">
        <div class="col-12 p-0" >
            <h6 class="bg-dark white text-bold-600 pl-1 mb-0 border-dark">Guide Instructions</h6>
            <p class="border-dark pl-1 mb-0 text-16 black " style="height: 90px;">{!!nl2br(html_entity_decode($overheadcrane2->locr2_43))!!}</p>
        </div>
    </div>
    <div class="row" style="margin-bottom: 3px;">
        <div class="col-12 p-0">
