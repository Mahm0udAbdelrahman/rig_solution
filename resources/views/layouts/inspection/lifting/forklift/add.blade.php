                        ...
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="purchaseOrder" name="lfr_2" class="form-control" placeholder="Purchase Order" disabled>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-4">
                        ...
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_8" name="lfr_8" class="form-control" placeholder="Color Code" value="" required="" data-validation-required-message="This field is required"/>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                      </div>
                            ...
                            {{--<div class="col-6">--}}
                                {{--<div class="form-group mb-0">--}}
                                    {{--<div class="controls">--}}
                                        ...
                                        {{--<input type="text" id="clientDepartment" name="clientDepartment"--}}
                                               {{--class="form-control"--}}
                        ...
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_10" name="lfr_10" class="form-control" placeholder="Equipment Description" value=""  required="" data-validation-required-message="This field is required">
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_11" name="lfr_11" class="form-control" placeholder="Name of Manufacturer" value=""  required="" data-validation-required-message="This field is required">
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_12" name="lfr_12" class="form-control" placeholder="Identification Number/chassis number" value="" required="" data-validation-required-message="This field is required" >
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_13" name="lfr_13" class="form-control" placeholder="Model/Type" value=""  required="" data-validation-required-message="This field is required">
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control dp-date-range-from" id="lfr_14" name="lfr_14" placeholder="Date of Manufacturer (if known)" />
                                  </div>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_15" name="lfr_15" class="form-control" placeholder="Crane Capacity (SWL)" value=""  required="" data-validation-required-message="This field is required">
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" id="lfr_16" name="lfr_16" class="form-control dp-date-range-from" placeholder="Date of last Through Examination" value=""  required="" data-validation-required-message="This field is required"/>
                                  </div>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_17" name="lfr_17" class="form-control" placeholder="Certificate Number" value=""  required="" data-validation-required-message="This field is required">
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_18" name="lfr_18" class="form-control" placeholder="Examined by" value="" required="" data-validation-required-message="This field is required" >
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-12">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_19" name="lfr_19" class="form-control" placeholder="Proof load test Details (if applied)" value="" required="" data-validation-required-message="This field is required"/>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-12">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_20" name="lfr_20" class="form-control" placeholder="Reference Standard" value="" required="" data-validation-required-message="This field is required"/>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card-content collapse show">
                    <div class="card-body">
                      <div class="row mt-1">
                        ...
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_21_y " name="lfr_21" required>
                              <label class="custom-control-label" for="lfr_21_y ">Yes</label>
                          </div>
                        </div>
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_21_n" name="lfr_21">
                      ...
                      <div class="row">
                        ...
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_22_y " name="lfr_22" required>
                              <label class="custom-control-label" for="lfr_22_y ">Yes</label>
                          </div>
                        </div>
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_22_n" name="lfr_22">
                  ...
                  <div class="card-content collapse show">
                    <div class="card-body">
                      <div class="row mt-1">
                        ...
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_23_y " name="lfr_23" required>
                              <label class="custom-control-label" for="lfr_23_y ">Yes</label>
                          </div>
                        </div>
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_23_n" name="lfr_23">
                      ...
                      <div class="row">
                        ...
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_24_y " name="lfr_24" required>
                              <label class="custom-control-label" for="lfr_24_y ">Yes</label>
                          </div>
                        </div>
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_24_n" name="lfr_24">
                      ...
                      <div class="row">
                        ...
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_25_y " name="lfr_25" required>
                              <label class="custom-control-label" for="lfr_25_y ">Yes</label>
                          </div>
                        </div>
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_25_n" name="lfr_25">
                      ...
                      <div class="row">
                        ...
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_26_y " name="lfr_26" required>
                              <label class="custom-control-label" for="lfr_26_y ">Yes</label>
                          </div>
                        </div>
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_26_n" name="lfr_26">
                        ...
                        <div class="col-12">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_27" name="lfr_27" class="form-control" placeholder="Identification of any part found to have a defect which is or could become a danger to persons and a description of the defect(if none state NONE)" value="" required="" data-validation-required-message="This field is required"/>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card-content collapse show">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_28_y " name="lfr_28">
                              <label class="custom-control-label" for="lfr_28_y ">Yes</label>
                          </div>
                        </div>
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_28_n" name="lfr_28">
                      ...
                      <div class="row">
                        ...
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_29_y " name="lfr_29">
                              <label class="custom-control-label" for="lfr_29_y ">Yes</label>
                          </div>
                        </div>
                        <div class="col-2">
                          <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="lfr_29_n" name="lfr_29">
                      ...
                      <div class="row">
                        ...
                        <div class="col-4">
                          <div class="input-group">
                              ...
                              <input type="text" class="form-control dp-date-range-from" id="lfr_30" name="lfr_30" />
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-12">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_31" name="lfr_31" class="form-control" placeholder="Particulars of any repair, renewal, or alteration to remedy the defect identified above" value="" required="" data-validation-required-message="This field is required"/>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-12">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="lfr_32" name="lfr_32" class="form-control" placeholder="Particulars of any tests carried out as part of the examination(if none state NONE)" value="" required="" data-validation-required-message="This field is required"/>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                      </div>
          ...
          <div class="card-content collapse show">
            <div class="card-body">
              <div class="row mt-1">
                ...
                <div class="col-2">
                  <div class="custom-control custom-radio">
                      <input type="radio" class="custom-control-input" id="lfr_33_y " name="lfr_33" required>
                      <label class="custom-control-label" for="lfr_33_y ">Yes</label>
                  </div>
                </div>
                <div class="col-2">
                  <div class="custom-control custom-radio">
                      <input type="radio" class="custom-control-input" id="lfr_33_n" name="lfr_33">
			          ...
			          $.ajax({
			            ...
			            success: function (data){
			              toastr.info('Good Job !', data.success, { positionClass: 'toast-bottom-left', "showMethod": "slideDown", "hideMethod": "slideUp", "progressBar": true, timeOut: 1000, fadeOut: 1000, onHidden: function () {
			                var uri = "{{route('forklift2_create.forklift', ':id')}}";
