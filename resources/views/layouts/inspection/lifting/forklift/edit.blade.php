                          ...
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <select class="form-control" id="lcr_1" name="lcr_1" required="" disabled>
                                      <option value="{{$forklift->job_request->id}}" selected>{{$forklift->job_request->code}}</option>
                                  </select>
                        ...
                        <div class="col-12 col-sm-4">
                          <div class="form-group mb-0">
                              <div class="controls">
                                  ...
                                  <input type="text" id="purchaseOrder" name="lfr_2" class="form-control" placeholder="Purchase Order" value="{{$forklift->lfr_2}}" required disabled>
                              <div class="help-block"></div></div>
                          </div>
                        </div>
                        <div class="col-12 col-sm-4">
