                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><input type="text" id="lfr2_2" name="lfr2_2" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                    </tr>
                    <tr>
                      ...
                      <td><input type="text" id="lfr2_4" name="lfr2_4" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><input type="text" id="lfr2_6" name="lfr2_6" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                    </tr>
                    <tr>
                      <th scope="row">Reverse</th>
                      <td>
                      ...
                      <td><input type="text" id="lfr2_8" name="lfr2_8" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><input type="text" id="lfr2_10" name="lfr2_10" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="text" id="lfr2_12" name="lfr2_12" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                </tr>
                <tr>
                  <th scope="row">Reverse</th>
                  <td>
                  ...
                  <td><input type="text" id="lfr2_14" name="lfr2_14" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="text" id="lfr2_16" name="lfr2_16" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                </tr>
                <tr>
                  ...
                  <td><input type="text" id="lfr2_18" name="lfr2_18" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="text" id="lfr2_20" name="lfr2_20" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                </tr>
                <tr>
                  ...
                  <td><input type="text" id="lfr2_22" name="lfr2_22" class="form-control" placeholder="Justify if not Satisfactory" value="" required="" data-validation-required-message="This field is required" disabled></td>
                </tr>
              </tbody>
            </table>
          </div>
              ...
              <div class="card-body">
                <div class="row ">
                  <div class="col-8 ">
                    <div class="row">
                      <div class="col-6">
                        <input type="checkbox" class="switchery" id="id-information" name="fork" >
                        <span class="mr-1"><label for="id-information">(01) ID/Information</label></span>
                      </div>
                      <div class="col-6">
                        <input type="text" id="lfr2_23" name="lfr2_23" class="form-control" placeholder="" value="" required="" data-validation-required-message="This field is required" disabled/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6">
                        <input type="checkbox" class="switchery" id="thickness" name="fork" >
                        <span class="mr-1"><label for="thickness">(02) Thickness</label></span>
                      </div>
                      <div class="col-6">
                        <input type="text" id="lfr2_24" name="lfr2_24" class="form-control" placeholder="" value="" required="" data-validation-required-message="This field is required" disabled/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6">
                        <input type="checkbox" class="switchery" id="blade-width" name="fork" >
                        <span class="mr-1"><label for="blade-width">(03) Blade Width</label></span>
                      </div>
                      <div class="col-6">
                        <input type="text" id="lfr2_25" name="lfr2_25" class="form-control" placeholder="" value="" required="" data-validation-required-message="This field is required" disabled/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6 ">
                        <input type="checkbox" class="switchery" id="blade-length" name="fork" >
                        <span class="mr-1"><label for="blade-length">(04) Blade Length</label></span>
                      </div>
                      <div class="col-6">
                        <input type="text" id="lfr2_26" name="lfr2_26" class="form-control" placeholder="" value="" required="" data-validation-required-message="This field is required" disabled/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6">
                        <input type="checkbox" class="switchery" id="distance-between-hooks" name="fork" >
                        <span class="mr-1"><label for="distance-between-hooks">(05) Distance between hooks</label></span>
                      </div>
                      <div class="col-6">
                        <input type="text" id="lfr2_27" name="lfr2_27" class="form-control" placeholder="" value="" required="" data-validation-required-message="This field is required" disabled/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6">
                        <input type="checkbox" class="switchery" id="shank-height" name="fork" >
                        <span class="mr-1"><label for="shank-height">(06) Shank Height ( Back height )</label></span>
                      </div>
                      <div class="col-6">
                        <input type="text" id="lfr2_28" name="lfr2_28" class="form-control" placeholder="" value="" required="" data-validation-required-message="This field is required" disabled/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6">
                        <input type="checkbox" class="switchery" id="hanger-type" name="fork" >
                        <span class="mr-1"><label for="hanger-type">(07) Hanger type: Hooks/Tube</label></span>
                      </div>
                      <div class="col-6">
                        <input type="text" id="lfr2_29" name="lfr2_29" class="form-control" placeholder="" value="" required="" data-validation-required-message="This field is required" disabled/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6 mid">
                        <input type="checkbox" class="switchery" id="shaft-diameter" name="fork" >
                        <span class="mr-1"><label for="shaft-diameter">(08) Shaft diameter</label></span>
                      </div>
                      <div class="col-6">
                        <input type="text" id="lfr2_30" name="lfr2_30" class="form-control" placeholder="" value="" required="" data-validation-required-message="This field is required" disabled/>
                      </div>
                    </div>
                  </div>
                  <div class="col-4">
                ...
                <div class="row mt-1">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lfr2_31_y " name="lfr2_31" required>
                        <label class="custom-control-label" for="lfr2_31_y ">Accept</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lfr2_31_n" name="lfr2_31">
                  ...
                  <div class="col-12 col-sm-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          ...
                          <input type="text" id="lfr2_32" name="lfr2_32" class="form-control" placeholder="Standard" value="" required="" data-validation-required-message="This field is required"/>
                  ...
                  <div class="col-12 col-sm-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          ...
                          <input type="text" id="lfr2_33" name="lfr2_33" class="form-control" placeholder="Equipment type" value="" required="" data-validation-required-message="This field is required">
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          ...
                          <input type="text" id="lfr2_34" name="lfr2_34" class="form-control" placeholder="Equipment No" value="" required="" data-validation-required-message="This field is required">
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          ...
                          <input type="text" id="lfr2_35" name="lfr2_35" class="form-control" placeholder="Pole spacing" value="" required="" data-validation-required-message="This field is required">
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12">
                    <div class="form-group mb-0">
                        <div class="controls">
                          ...
                          <input type="text" class="form-control dp-date-range-from" id="lfr2_36" name="lfr2_36" placeholder="Due Date" />
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><input type="text" id="lfr2_37" name="lfr2_37" class="form-control" placeholder="Contrast/Manufacturer" value="" required="" data-validation-required-message="This field is required"></td>
                          <td><input type="text" id="lfr2_38" name="lfr2_38" class="form-control" placeholder="Indicator/ Manufacturer" value="" required="" data-validation-required-message="This field is required"></td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dp-date-range-to" id="lfr2_39" name="lfr2_39" placeholder="Expire Date" required="" data-validation-required-message="This field is required"/>
                            </div>
                            <div class="help-block"></div></div>
                          </td>
                          <td>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dp-date-range-to" id="lfr2_40" name="lfr2_40" placeholder="Expire Date" required="" data-validation-required-message="This field is required"/>
                            </div>
                            <div class="help-block"></div></div>
                        </tr>
                      </tbody>
                  ...
                  <div class="col-12">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <textarea id="lfr2_41" name="lfr2_41" class="form-control" placeholder="Final Conclusion" value="" required="" data-validation-required-message="This field is required"></textarea>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
...
// Needed in some cases if the user went back (clean up)
    ...
    onFinished: function (event, currentIndex) {
        ...
        $.ajax({
          ...
          type: 'POST',
          url: "{{route('forklift2_create.store', $forklift)}}",
          processData: false,
          contentType: false,
          cache: false,
          data: formdata,
