                  ...
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="purchaseOrder" name="lter_2" class="form-control" placeholder="Purchase Order" disabled>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control datepicker-default" id="lcr_6" name="lcr_6" placeholder="Examination Date" required/>
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dp-date-range-to" id="lcr_7" name="lcr_7" placeholder="Next Examination Date" disabled/>
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_8" name="lter_8" class="form-control" placeholder="Color Code" value="" required/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="table-responsive col-12">
                    <table class="table titems">
                      ...
                      <tbody>
                        <tr>
                          <td class="col-md-2">
                            <textarea id="lter_10" name="lter_10" class="form-control" placeholder="Identification No" rows="13" style="resize: none;"></textarea>
                          </td>
                          <td class="col-md-1">
                            <textarea id="lter_11" name="lter_11" class="form-control" placeholder="Qty" rows="13" style="resize: none;"></textarea>
                          </td>
                          <td class="col-md-4">
                            <input type="text" id="lter_120" name="lter_120" class="form-control" placeholder="Title" value="" />
                            <textarea id="lter_12" name="lter_12" class="form-control" placeholder="Description" rows="13" style="resize: none;"></textarea>
                          </td>
                          <td class="col-md-2 text-right">
                            <textarea id="lter_13" name="lter_13" class="form-control" placeholder="SWL" rows="13" style="resize: none;"></textarea>
                          </td>
                          <td class="col-md-2 text-right">
                            <textarea id="lter_14" name="lter_14" class="form-control" placeholder="Proof Load" rows="13" style="resize: none;"></textarea>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_15" name="lter_15" class="form-control" placeholder="Attached to/Location" value="" required>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-6">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_16" name="lter_16" class="form-control" placeholder="Tare Weight" value="" required>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dp-date-range-from" id="lter_17" name="lter_17" placeholder="Last examination" required/>
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dp-date-range-from" id="lter_18" name="lter_18" placeholder="Date of Manufacture" required/>
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_19" name="lter_19" class="form-control" placeholder="Gross Mass" value="" required/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_20" name="lter_20" class="form-control" placeholder="Load Tested by" value="" required/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_21" name="lter_21" class="form-control" placeholder="Test Certificate #" value="" required/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dp-date-range-from" id="lter_22" name="lter_22" placeholder="Date of Test" required/>
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_23" name="lter_23" class="form-control" placeholder="Reference Standard" value="" required/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card-content collapse show">
              <div class="card-body">
                <div class="row mt-1">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_24_y " name="lter_24" required>
                        <label class="custom-control-label" for="lter_24_y ">Yes</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_24_n" name="lter_24">
                ...
                <div class="row">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_25_y " name="lter_25">
                        <label class="custom-control-label" for="lter_25_y ">Yes</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_25_n" name="lter_25">
            ...
            <div class="card-content collapse show">
              <div class="card-body">
                <div class="row mt-1">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_26_y " name="lter_26" required>
                        <label class="custom-control-label" for="lter_26_y ">Yes</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_26_n" name="lter_26">
                ...
                <div class="row">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_27_y " name="lter_27">
                        <label class="custom-control-label" for="lter_27_y ">Yes</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_27_n" name="lter_27">
                ...
                <div class="row">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_28_y " name="lter_28">
                        <label class="custom-control-label" for="lter_28_y ">Yes</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_28_n" name="lter_28">
                ...
                <div class="row">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_29_y " name="lter_29">
                        <label class="custom-control-label" for="lter_29_y ">Yes</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_29_n" name="lter_29">
                  ...
                  <div class="col-12">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_30" name="lter_30" class="form-control" placeholder="Identification of any part found to have a defect which is or could become a danger to persons and a description of the defect(if none state NONE)" value="" required/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card-content collapse show">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_31_y " name="lter_31">
                        <label class="custom-control-label" for="lter_31_y ">Yes</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_31_n" name="lter_31">
                ...
                <div class="row">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_32_y " name="lter_32">
                        <label class="custom-control-label" for="lter_32_y ">Yes</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_32_n" name="lter_32">
                ...
                <div class="row">
                  ...
                  <div class="col-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control dp-date-range-from" id="lter_33" name="lter_33" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-12">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_34" name="lter_34" class="form-control" placeholder="Particulars of any repair, renewal, or alteration   to remedy the defect identified above" value="" required/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="lter_35" name="lter_35" class="form-control" placeholder="Particulars of any repair, renewal, or alteration   to remedy the defect identified above" value="" required/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12 col-sm-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          ...
                          <input type="text" id="lter_37" name="lter_37" class="form-control in111" placeholder="Standard" value="" required="" data-validation-required-message="This field is required"/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          ...
                          <input type="text" id="lter_38" name="lter_38" class="form-control in111" placeholder="Equipment type" value="" required="" data-validation-required-message="This field is required">
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          ...
                          <input type="text" id="lter_39" name="lter_39" class="form-control in111" placeholder="Equipment No" value="" required="" data-validation-required-message="This field is required">
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          ...
                          <input type="text" id="lter_40" name="lter_40" class="form-control in111" placeholder="Pole spacing" value="" required="" data-validation-required-message="This field is required">
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><input type="text" id="lter_42" name="lter_42" class="form-control in111" placeholder="Contrast/Manufacturer" value="" required="" data-validation-required-message="This field is required"></td>
                          <td><input type="text" id="lter_43" name="lter_43" class="form-control in111" placeholder="Indicator/ Manufacturer" value="" required="" data-validation-required-message="This field is required"></td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dp-date-range-to in111" id="lter_44" name="lter_44" placeholder="Expire Date" required="" data-validation-required-message="This field is required"/>
                            </div>
                            <div class="help-block"></div></div>
                          </td>
                          <td>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dp-date-range-to in111" id="lter_45" name="lter_45" placeholder="Expire Date" required="" data-validation-required-message="This field is required"/>
                            </div>
                            <div class="help-block"></div></div>
                        </tr>
                      </tbody>
            ...
            <div class="card-content collapse show">
              <div class="card-body">
                <div class="row mt-1">
                  ...
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_51_y " name="lter_51" required>
                        <label class="custom-control-label" for="lter_51_y ">Yes</label>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="lter_51_n" name="lter_51">
                  ...
                  if($(this).is(':checked') === true){
                    formdata.append($(this).attr('name'), $(this).attr('id'));
			          ...
			          $.ajax({
			            ...
			            type: 'POST',
			            url: "{{route('throughExamination.store')}}",
			            processData: false,
			            contentType: false,
			            cache: false,
			            data: formdata,
