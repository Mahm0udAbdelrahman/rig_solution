                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <select class="form-control" id="lcr_1" name="lcr_1" required="" disabled>
                                <option value="{{$defect->job_request->id}}" selected>{{$defect->job_request->code}}</option>
                            </select>
                  ...
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="purchaseOrder" name="ldr_2" class="form-control" placeholder="Purchase Order" value="{{$defect->ldr_2}}" disabled>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
