                        ...
                        <div class="controls">
                            ...
                            <select class="form-control" id="lcr_1" name="lcr_1" required="">
                                ...
                                @foreach($jobrequests as $jobrequest)
                                    <option value="{{$jobrequest->id}}"  @if($jobrequest->id == $defect->job_request_id) selected @endif>{{$jobrequest->code}}</option>
                                @endforeach
                            </select>
                  ...
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="purchaseOrder" name="lcr_2" class="form-control" placeholder="Purchase Order" value="{{$defect->ldr_2}}" disabled>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="clearfix">
                              <input type="text" id="precode" class="form-control pr-0" placeholder="Report No" value="{{$defect->job_request->code}} /" required="" data-validation-required-message="This code field is required" aria-invalid="false" disabled style="width: 83px; float: left;">
                              <input type="text" id="code" name="code" class="form-control pl-0" placeholder="." value="{{$defect->code}}" required="" data-validation-required-message="This code field is required" aria-invalid="false" disabled  style="width: auto; float: left;">
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control datepicker-default" id="lcr_6" name="lcr_6" placeholder="Examination Date" required="" data-validation-required-message="This field is required" value="{{$defect->ldr_6}}"/>
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
          ...
          <div class="card repeater">
            <div class="card-content collapse show">
              <div class="card-body" data-repeater-list="payments">
                ...
                @if($defect->ldr_8 != null)
                  @foreach(json_decode($defect->ldr_8) as $value)
                <div class="row" data-repeater-item>
                  <div class="col-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          <textarea name="lcr_10" class="form-control" placeholder="ID / Description / Location">{{$value->lcr_10}}</textarea>
                          <div class="help-block"></div>
                        </div>
                    </div>
                  </div>
                  <div class="col-1">
                    <div class="form-group mb-0">
                        <div class="controls">
                          <textarea name="lcr_11" class="form-control" placeholder="SWL">{{$value->lcr_11}}</textarea>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="form-group mb-0">
                        <div class="controls">
                          <textarea name="lcr_12" class="form-control" placeholder="Defect">{{$value->lcr_12}}</textarea>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-3">
                    <div class="form-group mb-0">
                        <div class="controls">
                          <textarea name="lcr_13" class="form-control" placeholder="Recommendation/ Action">{{$value->lcr_13}}</textarea>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-2">
                    <div class="row">
                      <div class="col-4">
                        @if(isset($value->lcr_14))
                          <img class="media-object" src="{{Storage::url('camera/inspection/lifting/defect/')}}{{$value->lcr_14}}" alt="" width="64">
                          <input type=hidden name="lcr_140" value="{{$value->lcr_14}}" />
                        @endif
                      </div>
                      <div class="form-group mb-0 col-8">
                          <div class="controls">
                            <div class="defect-file-field">
                                <input type="file" class="form-control-file lcr_14 defect-photo-input" name="lcr_14" accept="image/*">
                                <small class="text-muted defect-photo-label d-block mt-25">{{ isset($value->lcr_14) && $value->lcr_14 ? ('Current: '.$value->lcr_14) : 'No file chosen' }}</small>
                            </div>
                            <div class="help-block"></div></div>
                      </div>
                    </div>
...
// Needed in some cases if the user went back (clean up)
                ...
                formdata.append('publish', 'yes');
                  ...
                  url: "{{route('defect.update', $defect->id)}}",
			            processData: false,
			            contentType: false,
			            cache: false,
			            data: formdata,
