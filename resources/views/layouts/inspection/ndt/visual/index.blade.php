...
@section('content')
		<section class="users-list-wrapper">
				<div class="users-list">
						@if ($visuals == 0)
								@include('layouts.repeated.nodata', ['route' => 'visual'])
						@else
								@can('create', 'App\Models\Inspection\Ndt\Visual')
										<a href="{{route('visual.create')}}" class="btn btn-primary clear"><i class="la la-plus"></i> Create New {{ucfirst(str_replace('All ', '', substr($page_name, 0, -1)))}}</a>
								@endcan
								<div class="card">
...
@include('layouts.scripts.datatables', ['route' => 'visual', 'columns' => ['code', 'nvr_6', 'client_department', 'deploc', 'acceptance', 'desc', 'client', 'action'],
