                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <select class="form-control" id="lcr_1" name="lcr_1" required="" disabled>
                                <option value="{{$visual->job_request->id}}" selected>{{$visual->job_request->code}}</option>
                            </select>
                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="clearfix">
                              ...
                              <input type="text" id="code" name="code" class="form-control pl-0" placeholder="." value="{{$visual->code}}" required="" data-validation-required-message="This code field is required" aria-invalid="false" disabled  style="width: auto; float: left;">
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
