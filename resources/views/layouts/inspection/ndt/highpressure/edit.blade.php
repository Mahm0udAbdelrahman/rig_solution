                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <select class="form-control" id="lcr_1" name="lcr_1" required=""
                                                            disabled>
                                                        <option value="{{$highPressure->job_request->id}}"
                                                                selected>{{$highPressure->job_request->code}}</option>
                                                    </select>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="clearfix">
                                                        <input type="text" id="precode" class="form-control pr-0"
                                                               ...
                                                               value="{{$highPressure->job_request->code}} /"
                                                               required=""
                                                        ...
                                                        <input type="text" id="code" name="code"
                                                               ...
                                                               value="{{$highPressure->code}}" required=""
                                                               data-validation-required-message="This code field is required"
                                                               aria-invalid="false" disabled
                                                    ...
                                                    <div class="col-md-3 col-sm-12">
                                                        <fieldset>
                                                            <input type="checkbox" class="nhpr_11" name="nhpr_11[]" value="{{$specification->code}}"
                                                                   ...
                                                                   @if(in_array($specification->code, json_decode($highPressure->nhpr_11))) checked @endif
                                                            >
                                                    ...
                                                    <div class="row input-group">
                                                        <div class="col-md-5 ml-2 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nhpr_28_y" name="nhpr_28" value="nhpr_28_y"
                                                                   {{$highPressure->checkbox_yes($highPressure->nhpr_28)}} required>
                                                            <label class="custom-control-label"
                                                                   for="nhpr_28_y">Yes</label>
                                                        </div>
                                                        <div class="col-md-5 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nhpr_28_n" value="nhpr_28_n"
                                                                   name="nhpr_28" {{$highPressure->checkbox_no($highPressure->nhpr_28)}}>
                                                            <label class="custom-control-label"
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <div class="row input-group">
                                                        <div class="col-md-5 ml-2 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nhpr_29_y" name="nhpr_29" value="nhpr_29_y"
                                                                   {{$highPressure->checkbox_yes($highPressure->nhpr_29)}} required>
                                                            <label class="custom-control-label"
                                                                   for="nhpr_29_y">Yes</label>
                                                        </div>
                                                        <div class="col-md-5 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nhpr_29_n" value="nhpr_29_n"
                                                                   name="nhpr_29" {{$highPressure->checkbox_no($highPressure->nhpr_29)}}>
                                                            <label class="custom-control-label"
                                                ...
                                                <div class="col-2">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" id="nhpr_31_y"
                                                               name="nhpr_31"
                                                               value="nhpr_31_y"
                                                               {{$highPressure->checkbox_yes($highPressure->nhpr_32)}}  required>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-2">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" id="nhpr_31_n"
                                                               name="nhpr_31" value="nhpr_31_n" {{$highPressure->checkbox_no($highPressure->nhpr_32)}}>
                                                        <label class="custom-control-label"
                                                               for="nhpr_31_n">Reject</label>
                                                    </div>
                                                </div>
