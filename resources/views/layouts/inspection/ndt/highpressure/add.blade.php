                                            ...
                                            <div class="row">
                                                @foreach($specifications as $specification)
                                                    <div class="col-md-3 col-sm-12">
                                                        <fieldset>
                                                            <input type="checkbox" class="nhpr_11 specification" name="nhpr_11[]" id="{{$specification->code}}" value="{{$specification->code}}">
                                                    ...
                                                    <div class="row input-group">
                                                        <div class="col-md-5 custom-control custom-radio ml-2">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nhpr_28_y" name="nhpr_28" value="nhpr_28_y" required>
                                                            <label class="custom-control-label"
                                                                   for="nhpr_28_y">Yes</label>
                                                        </div>
                                                        <div class="col-md-5 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nhpr_28_n" name="nhpr_28" value="nhpr_28_n">
                                                            <label class="custom-control-label"
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <div class="row input-group">
                                                        <div class="col-md-5 custom-control custom-radio ml-2">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nhpr_29_y" name="nhpr_29" value="nhpr_29_y" required>
                                                            <label class="custom-control-label"
                                                                   for="nhpr_29_y">Yes</label>
                                                        </div>
                                                        <div class="col-md-5 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nhpr_29_n" name="nhpr_29" value="nhpr_29_n">
                                                            <label class="custom-control-label"
                                                ...
                                                <div class="col-2">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" id="nhpr_31_y"
                                                               name="nhpr_31" value="nhpr_31_y" required>
                                                        <label class="custom-control-label"
