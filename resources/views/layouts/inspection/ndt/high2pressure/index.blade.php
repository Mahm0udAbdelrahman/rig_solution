...
@section('content')
		<section class="users-list-wrapper">
				<div class="users-list">
						@if ($high2_pressures == 0)
								@include('layouts.repeated.nodata', ['route' => 'high2Pressure'])
						@else
								@can('create', 'App\Models\Inspection\Ndt\High2Pressure')
										<a href="{{route('high2Pressure.create')}}" class="btn btn-primary clear"><i class="la la-plus"></i> Create New {{ucfirst(str_replace('All ', '', substr($page_name, 0, -1)))}}</a>
								@endcan
								<div class="card">
...
@include('layouts.scripts.datatables', ['route' => 'high2Pressure', 'columns' => ['code', 'nh2pr_10', 'client_department', 'deploc', 'acceptance', 'desc', 'client', 'action'],
