										...
										<div class="form-group mb-0">
											<div class="controls">
												...
												<select class="form-control" id="lcr_1" name="lcr_1" required=""
													disabled>
													<option value="{{$high2Pressure->job_request->id}}" selected>
														{{$high2Pressure->job_request->code}}</option>
												</select>
											...
											<div class="controls">
												...
												<div class="clearfix">
													<input type="text" id="precode" class="form-control pr-0"
														...
														value="{{$high2Pressure->job_request->code}} /" required=""
													...
													<input type="text" id="code" name="code" class="form-control pl-0"
														placeholder="." value="{{$high2Pressure->code}}" required=""
														data-validation-required-message="This code field is required"
										...
										<div class="form-group mb-0">
											<div class="controls">
												...
												<div class="input-group">
													...
													<input type="text" class="form-control dp-date-range-to" id="lcr_7"
														name="lcr_7" placeholder="Next Examination Date" required=""
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_10" name="nhpr_10" class="form-control"
													placeholder="Identification No" value="{{$high2Pressure->nh2pr_10}}"
									...
									<div class="controls">
										<div class="row">
											...
											<div class="col-md-3 col-sm-12">
												<fieldset>
													<input type="checkbox" class="nhpr_11 specification"
														name="nhpr_11[]" value="{{$specification->code}}"
													...
													<label
														for="{{$specification->code}}">{{$specification->name}}</label>
												</fieldset>
											</div>
											@endforeach
										</div>
										...
										<div class="form-group mb-0">
											<div class="controls">
												...
												<input type="text" id="edition" name="edition" class="form-control"
													placeholder="Edition" value="{{$high2Pressure->edition}}"
													required=""
													data-validation-required-message="This field is required" />
												<div class="help-block"></div>
											</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_14" name="nhpr_14" class="form-control"
													placeholder="Drawing Number" value="{{$high2Pressure->nh2pr_14}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_17" name="nhpr_17" class="form-control"
													placeholder="Surface Condition" value="{{$high2Pressure->nh2pr_17}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_20" name="nhpr_20" class="form-control"
													placeholder="Serial Number" value="{{$high2Pressure->nh2pr_20}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_21" name="nhpr_21" class="form-control"
													placeholder="Manufacturer" value="{{$high2Pressure->nh2pr_21}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_22" name="nhpr_22" class="form-control"
													placeholder="Coupling Type" value="{{$high2Pressure->nh2pr_22}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_23" name="nhpr_23" class="form-control"
													placeholder="Sound Velocity" value="{{$high2Pressure->nh2pr_23}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_24" name="nhpr_24" class="form-control"
													placeholder="Search Unit" value="{{$high2Pressure->nh2pr_24}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_25" name="nhpr_25" class="form-control"
													placeholder="Probe Frequency" value="{{$high2Pressure->nh2pr_25}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_27" name="nhpr_27" class="form-control"
													placeholder="Search Unit" value="{{$high2Pressure->nh2pr_27}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
												...
												<div class="row input-group">
													<div class="col-md-5 ml-2 custom-control custom-radio">
														<input type="radio" class="custom-control-input" id="nhpr_28_y"
															name="nhpr_28"
															{{$high2Pressure->checkbox_yes($high2Pressure->nh2pr_28)}}
														required>
													...
													<div class="col-md-5 custom-control custom-radio">
														<input type="radio" class="custom-control-input" id="nhpr_28_n"
															name="nhpr_28"
															{{$high2Pressure->checkbox_no($high2Pressure->nh2pr_28)}}>
										...
										<div class="form-group">
											<div class="controls">
												...
												<input type="text" id="nhpr_30" name="nhpr_30" class="form-control"
													placeholder="Calibration Due" value="{{$high2Pressure->nh2pr_30}}"
													data-validation--message="This field is " />
												<div class="help-block"></div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="controls">
												...
												<div class="custom-file">
													<input type="file" class="custom-file-input" id="nhpr_31"
														name="nhpr_31">
													<label class="custom-file-label" style="height: 2.80rem;"
														for="nhpr_31" aria-describedby="nhpr_31">Choose file</label>
												</div>
												<div class="help-block"></div>
											</div>
										</div>
											...
											<div class="col-2">
												<div class="custom-control custom-radio">
													<input type="radio" class="custom-control-input" id="nhpr_35_y"
														name="nhpr_35"
														{{$high2Pressure->checkbox_yes($high2Pressure->nh2pr_33)}}
													required>
													<label class="custom-control-label" for="nhpr_35_y ">Accept</label>
												</div>
											</div>
											<div class="col-2">
												<div class="custom-control custom-radio">
													<input type="radio" class="custom-control-input" id="nhpr_35_n"
														name="nhpr_35"
														{{$high2Pressure->checkbox_no($high2Pressure->nh2pr_33)}}>
													<label class="custom-control-label" for="nhpr_35_n">Reject</label>
												</div>
											</div>
