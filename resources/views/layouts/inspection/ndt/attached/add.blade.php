                  ...
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input disabled type="text" id="purchaseOrder" name="nar_2" class="form-control" placeholder="Purchase Order">
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control datepicker-default" id="nar_6" name="nar_6" placeholder="Examination Date" required="" data-validation-required-message="This field is required"/>
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input type="text" id="nar_15" name="nar_15" class="form-control" placeholder="Description" value="" required="" data-validation-required-message="This field is required"/>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body" data-repeater-list="payments">
                ...
                <div class="row" data-repeater-item>
                  <div class="col-7">
                    <div class="form-group mb-0">
                        <div class="controls">
                          <textarea id="nar_10" name="nar_10" class="form-control" placeholder="Attachment Photo"></textarea>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-4">
