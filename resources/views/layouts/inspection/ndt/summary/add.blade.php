                  ...
                  <div class="col-12 col-sm-4">
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <input disabled type="text" id="purchaseOrder" name="nsr_2" class="form-control" placeholder="Purchase Order" value="" >
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-4">
                    ...
                    <div class="form-group mb-0">
                        <div class="controls">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dp-date-range-from" id="nsr_6" name="nsr_6" placeholder="Examination Date" data-validation--message="This field is "/>
                            </div>
                        <div class="help-block"></div></div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      <div class="controls">
                        <input type="text" id="nsr_11" name="nsr_11" class="form-control" placeholder="Description" value="" data-validation--message="This field is "/>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <textarea id="nsr_12" name="nsr_12" class="form-control" placeholder="Summary 1" rows="10"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-2">
                                              <div class="custom-control custom-radio">
                                                  <input type="radio" class="custom-control-input" id="nsr_13_y " name="nsr_13" required>
                                                  <label class="custom-control-label" for="nsr_13_y ">Accept</label>
                                              </div>
                                          </div>
                                          <div class="col-2">
                                              <div class="custom-control custom-radio">
                                                  <input type="radio" class="custom-control-input" id="nsr_13_n" name="nsr_13">
