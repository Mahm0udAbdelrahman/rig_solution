...
@section('content')
		<section class="users-list-wrapper">
				<div class="users-list">
						@if ($summaries == 0)
								@include('layouts.repeated.nodata', ['route' => 'summary'])
						@else
								@can('create', 'App\Models\Inspection\Ndt\Summary')
										<a href="{{route('summary.create')}}" class="btn btn-primary clear"><i class="la la-plus"></i> Create New {{ucfirst(str_replace('All ', '', substr($page_name, 0, -1)))}}</a>
								@endcan
								<div class="card">
...
@include('layouts.scripts.datatables', ['route' => 'summary', 'columns' => ['code', 'client_department', 'deploc', 'desc', 'client', 'action'],
