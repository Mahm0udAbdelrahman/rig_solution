...
@section('content')
		<section class="users-list-wrapper">
				<div class="users-list">
						@if ($ultrasonics == 0)
								@include('layouts.repeated.nodata', ['route' => 'ultrasonic'])
						@else
								@can('create', 'App\Models\Inspection\Ndt\Ultrasonic')
										<a href="{{route('ultrasonic.create')}}" class="btn btn-primary clear"><i class="la la-plus"></i> Create New {{ucfirst(str_replace('All ', '', substr($page_name, 0, -1)))}}</a>
								@endcan
								<div class="card">
...
@include('layouts.scripts.datatables', ['route' => 'ultrasonic', 'columns' => ['code', 'nur_26', 'client_department', 'deploc', 'acceptance', 'desc', 'client', 'action'],
