                                                    ...
                                                    <select class="form-control" id="lcr_1" name="lcr_1" required="">
                                                        @foreach($jobrequests as $jobrequest)
                                                            <option value="{{$jobrequest->id}}"
                                                                    @if($jobrequest->id === $high3Pressure->job_request_id) selected @endif>{{$jobrequest->code}}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input disabled type="text" id="purchaseOrder" name="nh2pr_2"
                                                    ...
                                                    <div class="col-md-3 col-sm-12">
                                                        <fieldset>
                                                            <input type="checkbox" class="nh2pr_11" name="nh2pr_11"
                                                                   ...
                                                                   @if(in_array(strtolower(str_replace(' ', '-', $specification->name)), json_decode($high3Pressure->nh2pr_11))) checked
                                                                   @endif
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="edition" name="edition" class="form-control"
                                                           ...
                                                           value="{{$high3Pressure->edition}}" required=""
                                                           data-validation-required-message="This field is required"
                                                    />
                                                    <div class="help-block"></div>
                                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_10" name="nh2pr_10"
                                                           class="form-control" placeholder="Identification No"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_13" name="nh2pr_13"
                                                           class="form-control" placeholder="Acceptance Criteria"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_14" name="nh2pr_14"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_15" name="nh2pr_15"
                                                           class="form-control" placeholder="Material"
                                                           value="{{$high3Pressure->nh2pr_15}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_16" name="nh2pr_16"
                                                           class="form-control" placeholder="Material Thickness"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_17" name="nh2pr_17"
                                                           class="form-control" placeholder="Surface Condition"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_18" name="nh2pr_18"
                                                           class="form-control" placeholder="Surface Temperature"
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <label>Model</label>
                                                    <input type="text" id="nh2pr_19" name="nh2pr_19"
                                                           class="form-control" placeholder="Model"
                                                           value="{{$high3Pressure->nh2pr_19}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_20" name="nh2pr_20"
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_21" name="nh2pr_21"
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_22" name="nh2pr_22"
                                                           class="form-control" placeholder="Coupling Type"
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_23" name="nh2pr_23"
                                                           class="form-control" placeholder="Sound Velocity"
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_24" name="nh2pr_24"
                                                           class="form-control" placeholder="Search Unit"
                                                           value="{{$high3Pressure->nh2pr_24}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_25" name="nh2pr_25"
                                                           class="form-control" placeholder="Probe Frequency"
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_26" name="nh2pr_26"
                                                           class="form-control" placeholder="Probe Dia."
                                                           value="{{$high3Pressure->nh2pr_26}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_27" name="nh2pr_27"
                                                           class="form-control" placeholder="Search Unit"
                                                           value="{{$high3Pressure->nh2pr_27}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nh2pr_30" name="nh2pr_30"
                                                           class="form-control" placeholder="Calibration Due"
                                    ...
                                    @foreach(json_decode($high3Pressure->nh2pr_31) as $value)
                                        <div class="row repeater-item" data-repeater-item>
                                            ...
                                            <div class="col-1">
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <textarea id="ntir_436" name="ntir_436"
                                                                  class="form-control update-function"
                                            ...
                                            <div class="col-1">
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <textarea id="ntir_437" name="ntir_437"
                                                                  class="form-control update-function"
                                            ...
                                            <div class="col-1">
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <textarea id="ntir_438" name="ntir_438"
                                                                  class="form-control update-function"
                                            ...
                                            <div class="col-1">
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <textarea id="ntir_439" name="ntir_439"
                                                                  class="form-control update-function"
                                                ...
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <textarea id="ntir_440" name="ntir_440" class="form-control"
                                                                  disabled="">{{$value->ntir_440}}</textarea>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-1">
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <textarea id="ntir_441" name="ntir_441"
                                                                  class="form-control update-function"
                                                        >{{$value->ntir_441}}</textarea>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <textarea id="ntir_442" name="ntir_442" class="form-control"
                                                                  disabled="">{{$value->ntir_442}}</textarea>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    <div class="controls">
                                                        <textarea id="ntir_443" name="ntir_443" class="form-control"
                                                                  disabled="">{{$value->ntir_443}}</textarea>
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                            </div>
