...
@section('content')
		<section class="users-list-wrapper">
				<div class="users-list">
						@if ($mpipts == 0)
								@include('layouts.repeated.nodata', ['route' => 'mpipt'])
						@else
								@can('create', 'App\Models\Inspection\Ndt\Mpipt')
										<a href="{{route('mpipt.create')}}" class="btn btn-primary clear"><i class="la la-plus"></i> Create New {{ucfirst(str_replace('All ', '', substr($page_name, 0, -1)))}}</a>
								@endcan
								<div class="card">
...
@include('layouts.scripts.datatables', ['route' => 'mpipt', 'columns' => ['code', 'nmpr_28', 'client_department', 'deploc', 'acceptance', 'desc', 'client', 'action'],
