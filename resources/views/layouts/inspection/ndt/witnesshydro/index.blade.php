...
@section('content')
		<section class="users-list-wrapper">
				<div class="users-list">
						@if ($witness_hydross == 0)
								@include('layouts.repeated.nodata', ['route' => 'witnessHydro'])
						@else
								@can('create', 'App\Models\Inspection\Ndt\WitnessHydro')
										<a href="{{route('witnessHydro.create')}}" class="btn btn-primary clear"><i class="la la-plus"></i> Create New {{ucfirst(str_replace('All ', '', substr($page_name, 0, -1)))}}</a>
								@endcan
								<div class="card">
...
@include('layouts.scripts.datatables', ['route' => 'witnessHydro', 'columns' => ['report_code', 'nwhr_15', 'client_department', 'deploc', 'acceptance', 'desc', 'client', 'action'],
