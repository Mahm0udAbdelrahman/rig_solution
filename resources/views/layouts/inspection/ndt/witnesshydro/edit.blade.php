                                            ...
                                            <div class="form-group mb-0">
                                                <div class="controls">
                                                    ...
                                                    <select class="form-control" id="lcr_1" name="lcr_1" required=""
                                                            disabled>
                                                        <option value="{{$witnessHydro->job_request->id}}"
                                                                selected>{{$witnessHydro->job_request->code}}</option>
                                                    </select>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="clearfix">
                                                        <input type="text" id="precode" class="form-control pr-0"
                                                               ...
                                                               value="{{$witnessHydro->job_request->code}} /"
                                                               required=""
                                                        ...
                                                        <input type="text" id="code" name="code"
                                                               ...
                                                               value="{{$witnessHydro->code}}" required=""
                                                               data-validation-required-message="This code field is required"
                                                               aria-invalid="false" disabled
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control dp-date-range-to"
                                                               ...
                                                               data-validation-required-message="This field is required"
                                                               disabled value="{{$witnessHydro->nwhr_7}}"/>
                                                    </div>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" id="nwhr_10" name="nwhr_10"
                                                                   ...
                                                                   value="{{$witnessHydro->nwhr_10}}"
                                                                   data-validation--message="This field is "
                                                                   @if($witnessHydro->nwhr_10 == null) disabled @endif />
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row input-group">
                                                        <fieldset class="col-md-6">
                                                            <input type="checkbox" class="contactway" name="contactway"
                                                                   ...
                                                                   @if(in_array("hydrostatic", json_decode($witnessHydro->nwhr_8))) checked @endif />
                                                            <label for="hydrostatic">Hydrostatic</label>
                                                        </fieldset>
                                                        <fieldset class="col-md-6">
                                                            <input type="checkbox" class="contactway" name="contactway"
                                                                   id="pneumatic"
                                                                   @if(in_array("pneumatic", json_decode($witnessHydro->nwhr_8))) checked @endif>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <textarea id="nwhr_14" name="nwhr_14" class="form-control"
                                                              placeholder="Description">{{$witnessHydro->desc}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_16" name="nwhr_16" class="form-control"
                                                           placeholder="Pipe Test Data"
                                                           value="{{$witnessHydro->nwhr_16}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_18" name="nwhr_18" class="form-control"
                                                           placeholder="Type of Pipe" value="{{$witnessHydro->nwhr_18}}"
                                                           data-validation--message="This field is "/>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_19" name="nwhr_19" class="form-control"
                                                           placeholder="Size of Pipe" value="{{$witnessHydro->nwhr_19}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_20" name="nwhr_20" class="form-control"
                                                           placeholder="Test Fluid" value="{{$witnessHydro->nwhr_20}}"
                                                           data-validation--message="This field is "/>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_21" name="nwhr_21" class="form-control"
                                                           placeholder="Required test Pressure"
                                                           value="{{$witnessHydro->nwhr_21}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_22" name="nwhr_22" class="form-control"
                                                           placeholder="Test Fluid Temperature"
                                                           value="{{$witnessHydro->nwhr_22}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_24" name="nwhr_24" class="form-control"
                                                           placeholder="Start Time:" value="{{$witnessHydro->nwhr_24}}"
                                                           data-validation--message="This field is "/>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_25" name="nwhr_25" class="form-control"
                                                           placeholder="End Time" value="{{$witnessHydro->nwhr_25}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_27" name="nwhr_27" class="form-control"
                                                           placeholder="Actual Hold Time"
                                                           value="{{$witnessHydro->nwhr_27}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_28" name="nwhr_28" class="form-control"
                                                           placeholder="Pressure Range"
                                                           value="{{$witnessHydro->nwhr_28}}"
                                                           data-validation--message="This field is "/>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_29" name="nwhr_29" class="form-control"
                                                           placeholder="Type" value="{{$witnessHydro->nwhr_29}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_30" name="nwhr_30" class="form-control"
                                                           placeholder="Actual Test" value="{{$witnessHydro->nwhr_30}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row input-group">
                                                        <div class="col-md-6 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nwhr_32_y" name="nwhr_32"
                                                                   required {{$witnessHydro->checkbox_yes($witnessHydro->nwhr_32)}}>
                                                        ...
                                                        <div class="col-md-6 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nwhr_32_n"
                                                                   name="nwhr_32" {{$witnessHydro->checkbox_no($witnessHydro->nwhr_32)}}>
                                                            <label class="custom-control-label"
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <div class="row input-group">
                                                        <div class="col-md-6 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nwhr_33_y" name="nwhr_33"
                                                                   required {{$witnessHydro->checkbox_yes($witnessHydro->nwhr_33)}}>
                                                            <label class="custom-control-label"
                                                        ...
                                                        <div class="col-md-6 custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="nwhr_33_n"
                                                                   name="nwhr_33" {{$witnessHydro->checkbox_no($witnessHydro->nwhr_33)}}>
                                                            <label class="custom-control-label"
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nwhr_34" name="nwhr_34" class="form-control"
                                                           placeholder="Actual Test" value="{{$witnessHydro->nwhr_34}}"
                                                           data-validation--message="This field is "/>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <textarea id="nwhr_35" name="nwhr_35" class="form-control"
                                                              placeholder="Reason of Line loss">{{$witnessHydro->nwhr_35}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                        ...
                                        <div class="col-2 mt-1 mt-sm-0">
                                            <img class="media-object"
                                                 ...
                                                 src="{{Storage::url('camera/inspection/ndt/witnesshydro/')}}{{$witnessHydro->nwhr_36}}"
                                                 alt=""/>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <textarea id="nwhr_37" name="nwhr_37" class="form-control"
                                                              placeholder="Corrective Measures Taken">{{$witnessHydro->nwhr_37}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-2">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" id="nwhr_38_y "
                                                               name="nwhr_38"
                                                               {{$witnessHydro->checkbox_yes($witnessHydro->nwhr_38)}}  required>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-2">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" id="nwhr_38_n"
                                                               name="nwhr_38" {{$witnessHydro->checkbox_no($witnessHydro->nwhr_38)}}>
                                                        <label class="custom-control-label"
