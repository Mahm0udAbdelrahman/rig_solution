...
@push('page_content')
    ...
    <div class="row" style="margin-top: 3px;">
        ...
        <div class="col-6 p-0 pl-1 border-dark text-16 black">{{$model->inspection_description}}</div>

        <div class="bg-dark col-1 p-0 border-dark"><h6 class="white text-bold-600 pl-1 mb-0">Description</h6></div>
        <div class="col-3 p-0 pl-1 border-dark text-16 black">{{$model->description}}</div>
    </div>
    <!----------------------------------->
    <div class="row" style="margin-top: 3px;">
