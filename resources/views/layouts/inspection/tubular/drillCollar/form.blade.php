            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            <div class="controls">
                                {{ Form::label('dc_description', 'D/C Description:') }}
                                {{ Form::text('dc_description', null, ['class' => 'form-control', 'placeholder' => 'D/C Description', 'required']) }}
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            <div class="controls">
                                ...
                                {{ Form::text('size', null, ['class' => 'form-control', 'placeholder' => 'Size', 'required']) }}
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        ...
                        <tr data-repeater-item>
                            ...
                            <td>
                                <table style="width: 100%; text-align: center;">
                                    <tr style="height: 22px;">
                                        <td class=" p-0 border-dark white">
                                            <input type="text" id="{{'input_23'}}" name="{{'input_23'}}"  value="{{isset($item['input_23']) ? $item['input_23'] : '' }}" class="cell-input" placeholder="..." />
                                        </td>
                                    </tr>
                                </table>
...
<script>
  ...
  $(document).ready(function() {
    var pipeTypeStandards = @json($pipeTypeStandards);

    function updateInputs() {
      var selectedType = $('#standards_type').val();

      if (selectedType in pipeTypeStandards) {
        var standards = pipeTypeStandards[selectedType];

        for (var i = 1; i <= 11; i++) {
          var inputName = 'standards[input_' + i + ']';
          if (standards['input_' + i]) {
            $('input[name="' + inputName + '"]').val(standards['input_' + i]);
          } else {
    ...
    $('#standards_type').change(function() {
      updateInputs();
    });
  });
