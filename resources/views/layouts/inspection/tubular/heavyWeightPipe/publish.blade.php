...
@section('content')
    <section id="validation">
        <div class="row">
            <div class="col-12">
                {!! Form::model($model, ['route' => ['heavyWeightPipe.publishSubmit', $model->id], 'method' => 'PATCH', 'class'=> 'steps-validation wizard-circle']) !!}
                {{ csrf_field() }}
                @include('layouts.inspection.tubular.heavyWeightPipe.form');
                {!! Form::close() !!}
            </div>
        </div>
    </section>
