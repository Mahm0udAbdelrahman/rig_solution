            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <div class="row mt-1">
                            <table style="width: 100%;" class="text-center border">
                                ...
                                <tr>
                                    <td class="border-dark white text-bold-600" >Diameter</td>
                                    <td class="border-dark white" colspan="10">
                                        {{ Form::text('dimensions_data[diameter]', null, ['class' => 'form-control text-center', 'placeholder' => 'A..', 'required']) }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="border-dark white text-bold-600" >B Slots Length</td>
                                    <td class="border-dark white" colspan="10">
                                ...
                                <tr class="pipe_type_2" style="display:none;">
                                    <td class="border-dark white text-bold-600" >E Bore</td>
                                    <td class="border-dark white" colspan="10">
                                        {{ Form::text('dimensions_data[input_e]', null, ['class' => 'form-control text-center', 'placeholder' => 'E..']) }}
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="col-8 pipe_type_1" style="display:none;">
                        <img src="{{asset('app-assets/images/inspections/reamer-inspection/1.png')}}" class="inspection-img" />
                    </div>

                    <div class="col-8 pipe_type_2" style="display:none;">
                        <img src="{{asset('app-assets/images/inspections/reamer-inspection/2.png')}}" class="inspection-img" />
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mt-1">
                            <table style="width: 100%;" class="text-center border">
                                <tr>
                                    ...
                                    <td class=" bg-dark p-0 border-dark white text-bold-600 pipe_type_1" style="display:none;" width="5%">BOX</td>
                                    <td class=" bg-dark p-0 border-dark white text-bold-600 pipe_type_2" style="display:none;" width="5%">PIN</td>
                                    <td>
                                        <table style="width: 100%;" class="text-center border">
                                            <tr>
                                                <td class="border-dark white text-bold-600">OD</td>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            {{ Form::label('reamer_condition', 'Reamer Condition:') }}
                                            {{ Form::text('reamer_condition', null, ['class' => 'form-control', 'rows' => 2, 'required' => '', 'placeholder' => '', 'aria-invalid' => 'false', 'data-validation-required-message' => 'This field is required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            {{ Form::label('reamer_slots', 'Reamer Slots:') }}
                                            {{ Form::text('reamer_slots', null, ['class' => 'form-control', 'rows' => 2, 'required' => '', 'placeholder' => '', 'aria-invalid' => 'false', 'data-validation-required-message' => 'This field is required']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
