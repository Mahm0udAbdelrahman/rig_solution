            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            <div class="controls">
                                {{ Form::label('inspection_description', 'Inspection Description:') }}
                                {{ Form::text('inspection_description', null, ['class' => 'form-control', 'placeholder' => 'Inspection Description', 'required']) }}
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            <div class="controls">
                                ...
                                {{ Form::text('description', null, ['class' => 'form-control', 'placeholder' => 'D/C Description', 'required']) }}
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            <div class="controls">
                                ...
                                {{ Form::text('identification_no', null, ['class' => 'form-control', 'placeholder' => 'Identification No', 'required']) }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            <div class="controls">
                                {{ Form::label('standards_type', 'Pipe Type') }}
                                {{ Form::select('standards[type]', $pipeTypeOptions, null, ['class' => 'form-control', 'id' => 'standards_type', 'required']) }}
                                <div class="help-block"></div>
                            </div>
                        </div>
                    </div>
                ...
                <table style="width: 127%; margin-left:-12px; text-align: center; display: contents; font-size: 85%;">
                    <thead style="width: 100%;">
                    <tr>
                        <td  class=" bg-dark p-0 border-dark white" style="width: 4%;">Sub Type</td>
                        <td  class=" bg-dark p-0 border-dark white" style="width: 8%;">Serial Number</td>
                        <td class=" bg-dark p-0 border-dark white" style="width: 42%;" id="type_section_1">
                        </td>
                        <td class=" bg-dark p-0 border-dark white" style="width: 42%;" id="type_section_2">
                        </td>
				...
				<div class="row" style="margin-top: 40px;">
					...
					<div class="col-3">
						<div class="form-group">
							<div>
								<input type="file" name="inspection_data[{{ $index }}][photo]" onchange="previewImage(this)" accept="image/*" />
								@php
								...
								@else
									<img src="" class="photo_preview" alt="" style="display:none;" />
								@endif

								<textarea name="inspection_data[{{ $index }}][photo_description]" class="form-control" placeholder="Photo description...">{{ isset($item['photo_description']) ? $item['photo_description'] : '' }}</textarea>
							</div>
						</div>
					</div>
					@endforeach
					<script>
						function previewImage(input) {
							...
							reader.onload = function (e) {
								$(input).siblings('img.photo_preview').attr('src', e.target.result).show();
							}
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            {{ Form::text('connection_defective', null, ['class' => 'form-control', 'rows' => 2, 'required' => '', 'placeholder' => '', 'aria-invalid' => 'false', 'data-validation-required-message' => 'This field is required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            {{ Form::text('connection_accepted', null, ['class' => 'form-control', 'rows' => 2, 'required' => '', 'placeholder' => '', 'aria-invalid' => 'false', 'data-validation-required-message' => 'This field is required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            {{ Form::label('connection_to_be_repaired', 'Connection To Be Repaired:') }}
                                            {{ Form::text('connection_to_be_repaired', null, ['class' => 'form-control', 'rows' => 2, 'required' => '', 'placeholder' => '', 'aria-invalid' => 'false', 'data-validation-required-message' => 'This field is required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            {{ Form::label('total_connection_inspected', 'Total Connection Inspected:') }}
                                            {{ Form::text('total_connection_inspected', null, ['class' => 'form-control', 'rows' => 2, 'required' => '', 'placeholder' => '', 'aria-invalid' => 'false', 'data-validation-required-message' => 'This field is required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            {{ Form::label('joints_to_be_repaired', 'Joints To Be Repaired:') }}
                                            {{ Form::text('joints_to_be_repaired', null, ['class' => 'form-control', 'rows' => 2, 'required' => '', 'placeholder' => '', 'aria-invalid' => 'false', 'data-validation-required-message' => 'This field is required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            {{ Form::label('total_joints_inspected', 'Total Jonts Inspected:') }}
                                            {{ Form::text('total_joints_inspected', null, ['class' => 'form-control', 'rows' => 2, 'required' => '', 'placeholder' => '', 'aria-invalid' => 'false', 'data-validation-required-message' => 'This field is required']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    standardsTypeSelect.change(function() {
      ...
      // Define the HTML content for each type
      const PinTypeHeader = `@include('layouts.inspection.tubular.subsDimensional.partials.pinHeader')`;

      const BoxTypeHeader = `@include('layouts.inspection.tubular.subsDimensional.partials.boxHeader')`;


      // Update the content based on the selected type
      if (selectedType === 'type_1') {
        $('#type_section_1').html(PinTypeHeader);
        $('#type_section_2').html(PinTypeHeader);
      } else if (selectedType === 'type_2')  {
        $('#type_section_1').html(BoxTypeHeader);
        $('#type_section_2').html(PinTypeHeader);
      } else {
        $('#type_section_1').html(BoxTypeHeader);
        $('#type_section_2').html(BoxTypeHeader);
      }
    });
